...
export class AddNoteUseCase {
  ...
  private async addNote(addNoteRequestPresentation: AddNoteRequestPresentation): Promise<Note> {
    addNoteRequestPresentation.titre = "PREFIXE-" + addNoteRequestPresentation.titre
